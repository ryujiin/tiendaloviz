...
class Orden(models.Model):
	numero = models.CharField('Numero de Orden',max_length=128,db_index=True)
...
class OrdenNota(models.Model):
	orden = models.ForeignKey(Orden,related_name='notas',)
	usuario = models.ForeignKey(User,related_name='ordenes',null=True, blank=True)
...
class PagoEvento(models.Model):
	order = models.ForeignKey(Orden, related_name='pago eventos', verbose_name=_("Order"))
...
class EnvioEvento(models.Model):
	order = models.ForeignKey(Orden, related_name='envio_evento', verbose_name=_("Order"))
